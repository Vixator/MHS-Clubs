...
* Regular backups (e.g., via `pg\\\_dump`, or Docker volume snapshots) are recommended even during development once meaningful test data accumulates, to avoid data loss during schema changes or experimentation.
