...
/**
 * User profile entity stored in the NocoDB `users` table.
 *
...
data class User(
    ...
    /**
     * Returns true if this user is a staff administrator for all clubs.
     */
    val isStaff: Boolean
        get() = role == UserRole.Staff
